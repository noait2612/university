...
#proof[
  ...
  אבל $J$ היא תת־קבוצה סופית אז $f^(-1)(B)$ זה חיתוך סופי של קבוצות פתוחות ולכן הוא פתוח ב־$Y$ והמקור של כל קבוצה בסיסית תחת $f$ הוא קבוצה פתוחה ולכן $f$ רציפה.
]
...
#proof[
  ...
  $ U_n = mycases(U_n = B_(d_n) (a_n comma epsilon/(2N)), n<=N, U_n = X_n, n>N) $
