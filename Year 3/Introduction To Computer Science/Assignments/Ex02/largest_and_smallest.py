...
def scenario_is_correct_largest_and_smallest(first_number, second_number, third_number, expected_largest, expected_smallest):
    largest, smallest = largest_and_smallest(first_number, second_number, third_number)
    if largest != expected_largest or smallest != expected_smallest:
        return False
    return True