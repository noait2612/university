...
def check_largest_and_smallest():
    """Used Sugar Syntax instead of multiple if's for each case since is the same as a = a & True"""
    predicate = scenario_is_correct_largest_and_smallest(17, 1, 16, 17, 1)
    predicate &= scenario_is_correct_largest_and_smallest(1, 17, 6, 17, 1)
    predicate &= scenario_is_correct_largest_and_smallest(1, 1, 2, 2, 1)
    predicate &= scenario_is_correct_largest_and_smallest(-1, 0, -3, 0, -3)
    predicate &= scenario_is_correct_largest_and_smallest(2.25, 2.5, 2.75, 2.75, 2.25)
    return predicate
