...
#proof[
  ...
  מהגדרת התומך זה אומר ש־$(M+epsilon, infinity) subset.eq RR without K$, מהיות $epsilon$ שרירותי נובע שכל הקטע $(M, infinity)$ ב־$RR without K$, כלומר לכל $y in (M,infinity)$, $y in.not K$.\
