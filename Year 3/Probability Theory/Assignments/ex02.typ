...
#proof[
  ניקח את הוקטור $(x_1, x_2, x_3, x_4, y_1, y_2) in (L_1)^4 times (L_2)^2$.\
  בעצם יש לנו שישה מספרים בין $0$ ל־$1$: $x_1, x_2$ מחליטים באיזה מטבע להשתמש, $x_3,x_4$ זה הטלות של מטבע הוגן ו־$y_1,y_2$ הן הטלות של מטבע מוטה.\
  עבור המטבע ההוגן, אם $x<=1/2$ אז יש לנו עץ ואחרת פלי. עבור המטבע המוטה, אם $y<=3/4$ יש לנו עץ ואחרת פלי.\
  + הניסוי הראשון – עם $x_1$ נקבע איזה מטבע להטיל קודם: אם $x_1 <= 1/2$ נטיל קודם מטבע הוגן ואז מוטה ואם $x_1 > 1/2$ אז נטיל קודם מטבע מוטה ואז מטבע הוגן.
    במקרה זה $x_2$ יסמן את ההטלה של המטבע ההוגן ו־$y_1$ עבור ההטלה של המטבע המוטה.
  + הניסוי השני – נשתמש הפעם ב־$x_1$ לאיזה מטבע נטיל קודם ו־$x_2$ עבור איזה מטבע נטיל בפעם השנייה.\
    עבור $x_3$ נסמן את ההטלה של המטבע ההוגן ו־$y_1$ עבור המטבע המוטה. אם פעמיים נקבל הטלה של מטבע הוגן נשתמש ב־$x_4$ להטלה השנייה ואם נקבל פעמיים הטלה של מטבע מוטה נשתמש ב־$y_2$
  + הניסוי השלישי – שוב נשתמש ב־$x_1$ לבחירת המטבע – אם $x_1<=1/2$ נבחר מטבע הוגן ואם לא נבחר מטבע מוטה ואותו נטיל פעמיים.\
    אם זה המטבע ההוגן נשתמש ב־$x_3,x_4$ ואם זה המטבע המוטה נשתמש ב־$y_1,y_2$.
  נשים לב שבמקרים שלא השתמשנו בכל הקורדינטאות זה בסדר, כי בנינו מרחב מכפלה גדול יותר כדי להכליל את כלל המקרים (באותה מידה זה כמו להרחיב מרחב ולהגדיר שלאיברים החדשים שהוספנו במקרה זה יש הסתברות $0$!). כמובן שאם היינו מצמצמים את המרחב לא היינו יכולים לייצג אותו כמרחב מכפלה בגלל התלויות בשלבים הקודמים.
]
