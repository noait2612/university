...
הפונקציה מוגדרת היטב שכן $X inter X' = emptyset$ שכן כל $x_0 in X union X'$ נשלח לערך יחיד תחת $h$.\
...
יהי $x'_0 in X' without f^(-1)(X')$ (אם $X' without f^(-1)(X')=emptyset$ הטענה טריוויאלית כי $f$ חד־חד ערכית ועל ולכן הפיכה ו־$f^(-1)$ הפיכה של חד־חד ערכית ועל ולכן על).\
