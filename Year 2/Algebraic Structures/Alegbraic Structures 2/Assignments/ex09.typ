...
#solution[
  ...
  $
  קצת מגעיל אבל ניגש לעבודה; נראה לי הכי כדאי להתחיל עם החזקות הרביעיות, ולכן נפתח את הביטוי $s_1^2s_2^2$.
  $
    s_1^2 = (t_1 + t_2 + t_3)^2 = t_1^2 + t_2^2 + t_3^2 + 2(t_1t_2 + t_2t_3+t_1t_3) = t_1^2 + t_2^2 + t_3^2 + 2s_2 \
    s_2^2 = (t_1t_2 + t_1t_3+t_2t_3)^2 = t_1^2t_2^2+t_1^2t_3^2+t_2^2t_3^2+2(x_1x_2x_1x_3 + x_1x_2x_2x_3+x_1x_3x_2x_3) = t_1^2t_2^2+t_1^2t_3^2+t_2^2t_3^2 + 2s_1t_1t_2t_3 \
    s_1^2s_2^2 = (t_1^2 + t_2^2 + t_3^2 + 2s_2)(t_1^2t_2^2+t_1^2t_3^2+t_2^2t_3^2 + 2s_1t_1t_2t_3) \
    = t_1^4t_2^2 + 2t_1^4t_2t_3 + t_1^4t_3^2 + 2t_1^3t_2^3 + 8t_1^3t_2^2t_3 + 8t_1^3t_2t_3^2 + 2t_1^3t_3^3 + t_1^2t_2^4 \
    + 8t_1^2t_2^3t_3 + 15t_1^2t_2^2t_3^2 + 8t_1^2t_2t_3^3 + t_1^2t_3^4 + 2t_1t_2^4t_3 + 8t_1t_2^3t_3^2 + 8t_1t_2^2t_3^3 + 2t_1t_2t_3^4 + t_2^4t_3^2 + 2t_2^3t_3^3 + t_2^2t_3^4 \
    P-s_1^2s_2^2 = -4t_1^4t_2t_3 - 4t_1^3t_2^3 - 6t_1^3t_2^2t_3 - 6t_1^3t_2t_3^2 - 4t_1^3t_3^3 - 6t_1^2t_2^3t_3 - 21t_1^2t_2^2t_3^2 - 6t_1^2t_2t_3^3 - 4t_1t_2^4t_3 - 6t_1t_2^3t_3^2 - 6t_1t_2^2t_3^3 - 4t_1t_2t_3^4 - 4t_2^3t_3^3
  $
  מאותן סיבות כמקודם, נוריד $-4s^3s_3$ ונקבל
  $
    P - s_1^2s_2 - (-4s^3s_3) = 4t_1^4t_2^4t_3 + 12t_1^4t_2^3t_3^2 + 12t_1^4t_2^2t_3^3 + 4t_1^4t_2t_3^4 - 4t_1^4t_2t_3 + 12t_1^3t_2^4t_3^2 + 24t_1^3t_2^3t_3^3 - 4t_1^3t_2^3 + 12t_1^3t_2^2t_3^4 - 6t_1^3t_2^2t_3 \
    - 6t_1^3t_2t_3^2 - 4t_1^3t_3^3 + 12t_1^2t_2^4t_3^3 + 12t_1^2t_2^3t_3^4 - 6t_1^2t_2^3t_3 - 21t_1^2t_2^2t_3^2 - 6t_1^2t_2t_3^3 + 4t_1t_2^4t_3^4 - 4t_1t_2^4t_3 - 6t_1t_2^3t_3^2 - 6t_1t_2^2t_3^3 - 4t_1t_2t_3^4 - 4t_2^3t_3^3
  $
  עכשיו נוריד $-4s_2^3$ ומההפרש נקבל
  $
    4t_1^4t_2^4t_3 + 12t_1^4t_2^3t_3^2 + 12t_1^4t_2^2t_3^3 + 4t_1^4t_2t_3^4 - 4t_1^4t_2t_3 + 12t_1^3t_2^4t_3^2 + 24t_1^3t_2^3t_3^3 + 12t_1^3t_2^2t_3^4 + 6t_1^3t_2^2t_3 + 6t_1^3t_2t_3^2 + 12t_1^2t_2^4t_3^3 \
    + 12t_1^2t_2^3t_3^4 + 6t_1^2t_2^3t_3 + 3t_1^2t_2^2t_3^2 + 6t_1^2t_2t_3^3 + 4t_1t_2^4t_3^4 - 4t_1t_2^4t_3 + 6t_1t_2^3t_3^2 + 6t_1t_2^2t_3^3 - 4t_1t_2t_3^4
  $
  נשאר להוריד $12s_1s_2s_3$ וגם $-27s_3^2$, בסך הכל קיבלנו:
  $ P = s_1^2s_2^2-4s_1^3s_3-4s_2^3+12s_1s_2s_3-27s_3^2 $
]
